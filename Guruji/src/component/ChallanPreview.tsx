...
// Blue — used only as accent (borders + text). Backgrounds stay white/very-light-gray.
const accent = "#1d4ed8";
const accentLight = "#eff6ff";   // barely-there tint — prints as white in B&W
...
function ChallanPreview({ clientInfo, quotationDate, quotationRef, items, supplyInfo, challanSerial, shippedToInfo }: any) {
  ...
  const challanNumber = challanSerial || formatSerialNumber(0, "challan");
    ...
    <div className="h-full p-4 overflow-y-auto custom-scrollbar">
      <div ref={quotationRef} style={{ fontFamily: "Arial, sans-serif", fontSize: "11px", color: "#111", background: "#fff", padding: "16px" }}>
        <div style={{ border: `1px solid ${borderColor}`, borderRadius: "4px", overflow: "hidden" }}>
          ...
          {/* ── HEADER ── white background, color in text + borders only */}
          <div style={{ display: "flex", alignItems: "stretch", borderBottom: `1px solid ${divider}`, background: "#fff" }}>
            ...
            <div style={{ padding: "10px 14px", textAlign: "center", minWidth: "130px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
              <div style={{
                ...
                <div style={{ fontWeight: "bold", fontSize: "13px", color: accent, letterSpacing: "1px" }}>CHALLAN</div>
              </div>
          ...
          <div style={{ display: "flex", borderBottom: `1px solid ${divider}`, background: "#fafafa" }}>
            <div style={{ flex: 1, padding: "7px 12px", borderRight: `1px solid ${divider}`, borderLeft: `3px solid ${accent}` }}>
              <div style={{ marginBottom: "3px" }}>
                <span style={fieldLabel}>Challan No. :</span> {challanNumber}
              </div>
              <div>
                <span style={fieldLabel}>Challan Date :</span>{" "}
                {quotationDate ? quotationDate.format("DD/MM/YYYY") : "___________"}
              </div>
              <div style={{ marginTop: "3px" }}>
                <span style={fieldLabel}>Reverse Charge :</span> N/A
              </div>
            </div>
              ...
              {supplyInfo?.showInPreview ? (
                <div style={{ display: "flex", gap: "20px" }}>
                  <div>
                    ...
                    <div style={{ marginTop: "3px" }}>
                      <span style={fieldLabel}>P.O. No. :</span>{" "}
                      <span style={{ borderBottom: "1px solid #bbb", display: "inline-block", minWidth: "80px" }}>&nbsp;</span>
                    </div>
                  </div>
                  <div>
                    ...
                    <div style={{ marginTop: "3px" }}>
                      <span style={fieldLabel}>G.R. No. :</span>{" "}
                      <span style={{ borderBottom: "1px solid #bbb", display: "inline-block", minWidth: "80px" }}>&nbsp;</span>
                    </div>
                  </div>
                </div>
